                            ...
                            children: <Widget>[
                              ...
                              FormBuilderTextField(
                                ...
                                validator: FormBuilderValidators.required(
                                  errorText:
                                      translations.full_name_required_error,
                                ),
                                decoration: InputDecoration(
                                  hintText: translations.full_name_hint,
                                  ...
                                  Expanded(
                                    child: RichText(
                                      text: TextSpan(
                                        ...
                                        children: <InlineSpan>[
                                          TextSpan(
                                            // Primer fragmento antes del enlace
                                            text: translations
                                                .accept_terms(
                                          ...
                                          TextSpan(
                                            text: translations.terms_of_service,
                                            style: const TextStyle(
                                          ...
                                          TextSpan(
                                            text: translations.privacy_policy,
                                            style: const TextStyle(
                                              color: Colors.cyanAccent,
                                              fontWeight: FontWeight.bold,
                                            ),
                                          ...
                                          TextSpan(
                                            // Fragmento después del segundo enlace
                                            text:
                                                translations
                                                        .accept_terms(
                                                          translations
                                      ...
                                      onPressed: () {
                                        if (!_acceptTerms) {
                                          ThToast.error(
                                            ...
                                            title: translations.error_title,
                                            description:
                                                translations.accept_terms_error,
