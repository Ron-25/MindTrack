...
class MTColors {
  ...
  Color get surfaceSubtle => isDark ? AppColors.darkSurface : const Color(0xFFF8FAFC);
  ...
  Color get borderSubtle => isDark ? AppColors.darkBorder : const Color(0xFFF1F5F9);

  /// Texto principal (#0F172A / #1E293B en claro).
  Color get textPrimary => isDark ? AppColors.darkTextPrimary : const Color(0xFF0F172A);

  /// Texto secundario (#64748B / #475569 en claro).
  Color get textSecondary => isDark ? AppColors.darkTextSecondary : const Color(0xFF64748B);

  /// Texto atenuado (#94A3B8 en claro).
  Color get textMuted => isDark ? const Color(0xFF7C8AA0) : const Color(0xFF94A3B8);

  /// Relleno de pistas de progreso y controles segmentados (#F1F5F9).
  Color get trackFill => isDark ? AppColors.darkBorder : const Color(0xFFF1F5F9);

  /// Chip/checkbox sin seleccionar (#CBD5E1 / #D1D5DB en claro).
  Color get controlBorder => isDark ? const Color(0xFF3B4A61) : const Color(0xFFCBD5E1);
}
